package ayc.repository;

import ayc.ReferenceApp;

import ayc.config.Constants;
import ayc.config.audit.AuditEventConverter;
import ayc.domain.PersistentAuditEvent;
...
import static ayc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
